# Embedded file name: /usr/lib/enigma2/python/Components/Converter/SkalliClockToText.py
from Components.Converter.Converter import Converter
from time import localtime, strftime
from Components.Element import cached

class SkalliClockToText(Converter, object):
    DEFAULT = 0
    WITH_SECONDS = 1
    IN_MINUTES = 2
    DATE = 3
    ...
    def getText(self):
        ...
        elif self.type == self.AS_LENGTH_H_M:
